...
* 🧠 Python & AI Developer with **3.3 years** of experience in generative AI, enterprise search, and advanced computer vision systems. 
* 🏢 Worked as **Python/ML Developer at Texila Educare Healthcare and Technology Enterprise Pvt.** (May 2025 – Nov 2025) — led development of a real-time CCTV monitoring & smart attendance platform. 
...
**🚀 Project: Netrica AI — Real-time CCTV Monitoring & Smart Attendance**

* Led end-to-end development of **Netrica AI**, a production-ready CCTV monitoring & smart attendance system integrating face detection, recognition, posture analysis, and automated attendance logging. 
* Implemented face recognition pipeline using **YOLOv8 (face detection)**, **MediaPipe FaceMesh (alignment)**, and **ArcFace ONNX (512-D embeddings)** with **FAISS / cosine similarity** for identity verification. 
* Built resilient RTSP ingestion (FFmpeg), multithreaded processing, frame buffering, auto-reconnect and GPU/ONNX optimizations for multi-camera live streams. 
* Developed backend services (Flask + FastAPI) for camera control, MJPEG streaming, attendance logs, crowd alerts, and secure auth; Streamlit onboarding app for face registration and embedding creation. 

---

### 🏢 Previous — PBS Info Systems (Jan 2024 – Apr 2025)

**✅ Document AI Pipeline**

* Built a Snowflake-native Document AI ETL with metadata-driven validation, PDF ingestion, retry monitoring, and Streamlit LiveView dashboards. *(GitHub link preserved below.)* 

**✅ Cortex Search / Cortex Analyst / Cortex Agent**

* Architected hybrid semantic search and LLM-to-SQL tools on Snowflake (Cortex + LangChain) and built a JWT-authenticated Cortex Agent (FastAPI + React). *(GitHub links preserved below.)* 

**✅ Anomaly Forecasting**

* Implemented time-series forecasting & anomaly detection workflows in Snowflake; supervised & unsupervised approaches with native SQL orchestration. 

---

### 🏢 Previous — Dot Com Infoway Ltd (Sep 2022 – Dec 2023)

* Built an **AI ChatBot for Women’s Safety** (Django + LLM + voice-to-text + keyword filters). 
* Fixed SMTP issues (AkshayaIndia) and built an **image upscaling platform** using EDSR, OpenCV & DL (2×/4×/8×). 
...
*(All project links preserved from your original README.)*
